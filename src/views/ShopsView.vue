<template>
  <div class="shops-view">
    ...
    <div v-if="showDebug" class="debug-panel">
      ...
      <p><strong>Highlighted Shop:</strong> {{ highlightedShopId }}</p>
...
import ShopsListView from '../components/shops/ShopsListView.vue'
...
// Set up the shops tab as active when this view loads
onMounted(() => {
  console.log('ShopsView mounted')
  console.log('Current route:', route.path)
  console.log('Route query:', route.query)
  console.log('Highlighted shop ID:', props.highlightedShopId)
})
